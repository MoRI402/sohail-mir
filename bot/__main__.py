...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Owner", "https://t.me/SohailKhan_IndiAnime")
    buttons.buildbutton("Channel", "https://t.me/IndiAnimeBots")
...
'''
        ...
        sendMarkup('Bhag Bencho', context.bot, update, reply_markup)
